// src/modules/auction/infraestructure/api/controllers/AuctionController.ts
...
/**
 * Controlador HTTP para recursos de subastas.
 * @remarks
 * Traduce HTTP ↔ casos de uso de {@link AuctionService}. No contiene reglas de negocio.
 * Devuelve DTOs serializables (vía {@link AuctionMapper}).
 */
export class AuctionController {
  /**
   * @param auctionService Servicio de orquestación de subastas.
   */
  constructor(private readonly auctionService: AuctionService) {}

  /**
   * POST /auctions
   * @description Crea una subasta usando el token del usuario.
  ...
  /**
   * GET /auctions/:id
   * @description Obtiene una subasta por ID.
  ...
  /**
   * GET /auctions
   * @description Lista subastas abiertas.
   ...
   * @description Registra una puja usando el token del usuario.
   ...
   * @description Ejecuta compra inmediata (buy now) usando el token del usuario.
   * @status 200 OK | 401 Unauthorized | 404 Not Found | 403 Forbidden | 500 Internal Error
   */
   ...
   * @description Obtiene las pujas de una subasta.
   * @status 200 OK | 404 Not Found | 500 Internal Error
   */
  ...
  /**
   * GET /me
   * @description Obtiene el usuario actual a partir del token.
  ...
  /**
   * GET /history/purchased/:userId
   * @description Historial de subastas compradas por un usuario.
   * @status 200 OK | 500 Internal Error
   */
  ...
  /**
   * GET /history/sold/:userId
   * @description Historial de subastas vendidas por un usuario.
   * @status 200 OK | 500 Internal Error
   */
